...
const createNewCountry = (payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllCountry = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (search) {
        andConditions.push({
            OR: country_constans_1.countrySearchableFields.map((field) => ({
                [field]: {
                    contains: search,
                    mode: "insensitive",
                },
