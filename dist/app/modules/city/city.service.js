...
const createNewCity = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.city.create({
        data: payload,
    });
    return result;
});
const updateCity = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllCity = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (search) {
        andConditions.push({
            OR: city_constans_1.citySearchableFields.map((field) => ({
                [field]: {
                    contains: search,
                    mode: "insensitive",
                },
    ...
    const total = yield prisma_1.default.city.count({
        where: whereConditions,
    });
    return {
        meta: {
...
const isAlreadyExist = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.city.findUnique({
        where: {
            name: payload.name,
        },
